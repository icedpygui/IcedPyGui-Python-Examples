...
ipg.add_text(parent_id="cont", content="The window debug flag is set to better show the changes that occur when the "
                                       "sliders are changed and the offsets for the menu items.")
...
# adding some controls to see the effect of bar parameters
ipg.add_text(parent_id="controls",
             content="Reset the height to zero then see padding effect. \n Otherwise, the surrounding padding will "
                     "quash the bar items when big enough")
